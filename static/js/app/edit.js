...
function(Layer, Annotator, util) {
  ...
  function createSidebar(params, data, annotator) {
    ...
    exportButton.addEventListener("click", function () {
      ...
      data = {'filename':filename, 'data':annotator.export()};
    ...
    undoButton.appendChild(document.createTextNode("撤销操作"));
    undoButton.addEventListener("click", function () { annotator.undo(); });
    redoButton.className = "edit-sidebar-button";
    redoButton.appendChild(document.createTextNode("重做操作"));
    ...
    polygonToolButton.appendChild(document.createTextNode("形状标注"));
    ...
    brushToolButton.appendChild(document.createTextNode("逐点标注"));
